...
public class Concurso {
    ...
    public String formatarComNumerosSorteadosOrdenados() {
        List<Integer> listaSorteadoOrdenados = ConversorArrayParaLista.converterOrdenado(sorteados);
        return "Concurso{" +
                "numero=" + numero +
                ", data=" + data +
                ", sorteados=" + listaSorteadoOrdenados +
                '}';
    }
